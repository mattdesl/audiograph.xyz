...
module.exports = function () {
  ...
  player.getCurrentTime = () => {
    return playingAudio ? playingAudio.element.currentTime : 0;
  };
  player.getCurrentTrackIndex = () => currentPlayingIndex;
  ...
  function playQueued () {
    ...
    currentPlayingIndex = playlistCounter - 1;
    queuedAudio.play();
    if (audioStartTime > 0) queuedAudio.element.currentTime = audioStartTime;

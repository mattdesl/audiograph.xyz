...
function SSRPass (renderer, camera) {
  ...
  this.uniforms = {
    ...
    constantPixelStride: { type: 'f', value: 20 },
    pixelStrideZCutoff: { type: 'f', value: 1 },
    maxRayDistance: { type: 'f', value: 50 },
    ...
    cb_zThickness: { type: 'f', value: 100 },
    // cb_zCutoff: { type: 'f', value: 1 }
  };

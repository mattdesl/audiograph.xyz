...
EffectComposer.prototype = {
  ...
  render: function ( delta ) {
    ...
    for ( i = 0, passIndex = 0; i < il; i ++ ) {
      ...
      // var depthTexture = passIndex === 0 ? undefined : this.initialRenderTarget.depthTexture;
      var attachments = this.initialRenderTarget.attachments;
      pass.render( this.renderer, writeTarget, readTarget, delta, maskActive, this.depthTexture, attachments );

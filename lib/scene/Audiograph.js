...
module.exports = class Audiograph extends THREE.Scene {
  ...
  createAudioTimeline () {
    ...
    const geometryOpts = [
      ...
      { dance: false, additional: 5, palette: ["#230f2b","#f21d41","#bce3c5"] },
      { dance: true, additional: 4, palette: ["#0e2430","#e8d5b7","#f5b349","#e8d5b9"] },
      { dance: true, additional: 8, palette: ["#424254","#64908a","#e8caa4"] },

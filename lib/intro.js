...
module.exports = function (opt = {}, cb = noop) {
  ...
  //   animateIn(intro1a, { delay: 0.5 }, () => {
  //     animateOut(intro1a, { delay: WAIT_TIME_A }, () => {
  //       showIntroTrackName();
  //     });
  //   });
  // }
  ...
  function getAnimatables (element) {
    const children = Array.prototype.slice.call(element.querySelectorAll('p'));
